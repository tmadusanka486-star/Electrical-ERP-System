...
python -m PyInstaller --name "MyShopERP" --clean --noconsole --onefile --collect-all supabase --hidden-import supabase --add-data "templates;templates" --add-data "static;static" desktop_app.py
