...
python -m PyInstaller --name "MyShopERP" --clean --noconsole --onedir --icon="logo.ico" --collect-all supabase --hidden-import supabase --add-data "templates;templates" --add-data "static;static" --add-data ".env;." --add-data "logo.ico;." desktop_app.py
